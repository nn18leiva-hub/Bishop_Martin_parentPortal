...
const BankDetails = () => {
  ...
  // Theme-aware palette using CSS variables for DOM-level robustness
  const c = {
    pageBg:        'var(--page-bg, #faf9f6)',
    cardBg:        'var(--card-bg, #ffffff)',
    cardBorder:    'var(--border-color, #eaeaea)',
    headerBg:      'var(--card-bg, #ffffff)',
    headerBorder:  'var(--border-color, #eaeaea)',
    warmBg:        'var(--page-bg, #f4f1eb)',
    warmBorder:    'var(--border-color, #e5e3df)',
    warmDivider:   'var(--border-color, #e0deda)',
    alertBg:       'var(--pending-bg, #fff9e6)',
    assistBg:      'var(--page-bg, #f7f6f4)',
    assistBorder:  'var(--border-color, #e8e6e1)',
    refBg:         'var(--page-bg, #f4f1eb)',
    copyBtnBg:     'var(--secondary-btn, #ffffff)',
    copyBtnBorder: 'var(--secondary-btn-border, #dcdad5)',
    textMain:      'var(--text-color, #1a1a1a)',
    textSub:       'var(--text-sub, #666663)',
    textMuted:     'var(--text-muted, #8e8b82)',
    textValue:     'var(--text-value, #2d2d2d)',
    divider:       'var(--divider, #f0f0f0)',
    stepInactiveBg:'var(--step-inactive-bg, #ffffff)',
    stepInactiveBorder: 'var(--step-inactive-border, #cccccc)',
    pendingBg:     'var(--pending-bg, #fbf5e1)',
    timelineDivider: 'var(--timeline-divider, #eaeaea)',
    secondaryBtn:  'var(--secondary-btn, #ffffff)',
    secondaryBtnBorder: 'var(--secondary-btn-border, #dcdad5)',
    secondaryBtnText: 'var(--secondary-btn-text, #4a4743)',
    refTextColor:  'var(--ref-text-color, #4a4743)',
    breadcrumbSub: 'var(--breadcrumb-sub, #888888)',
  };
