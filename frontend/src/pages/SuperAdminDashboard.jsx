    ...
    if (userObject?.avatar_path) {
      ...
      return (
        <img 
          ...
          style={{ width: `${size}px`, height: `${size}px`, borderRadius: '50%', objectFit: 'cover', border: '1px solid #eaeaea', marginLeft: '0.25rem' }}
          onError={(e) => {
    ...
    <div style={{ padding: '1rem 1.5rem 2rem 1.5rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginLeft: 'auto' }}>
          ...
          <HeaderActions />
          <Link to="/profile" style={{ display: 'inline-flex', textDecoration: 'none' }}>
